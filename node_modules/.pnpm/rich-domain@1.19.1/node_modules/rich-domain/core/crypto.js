...
const GenerateUUID = () => {
    const GetRandom = () => chars[Math.trunc(Math.random() * chars.length)];
    const GetRandomAsc = () => charsAsc[Math.trunc(Math.random() * charsAsc.length)];
...
exports.UUID = randomUUID || exports.GenerateUUID;
