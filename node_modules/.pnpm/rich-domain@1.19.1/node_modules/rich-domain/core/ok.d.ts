 ...
 */
declare function Ok(): Result<void, string, {}>;
/**
 * @description Create an instance of Result as success state.
 * @param data generic type P
 * @param metaData generic type M
 ...
 * @default void as no state.
 */
declare function Ok(): IResult<void, string, {}>;
/**
 * @description Create an instance of Result as success state.
 * @param data generic type P
 * @param metaData generic type M
 ...
 * @default void as no state.
 */
declare function Ok<P, M extends {} = {}, E = string>(data: P extends void ? null : P, metaData?: M): Result<P, E, M>;
/**
 * @description Create an instance of Result as success state.
 * @param data generic type P
 * @param metaData generic type M
 ...
 * @default void as no state.
 */
declare function Ok<P, M extends {} = {}, E = string>(data: P extends void ? null : P, metaData?: M): IResult<P, E, M>;
export default Ok;
export { Ok };
