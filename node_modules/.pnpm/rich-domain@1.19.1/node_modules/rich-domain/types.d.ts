...
export type IPropsValidation<T> = {
...
export interface IEntity<Props> {
    toObject<T>(adapter?: IAdapter<IEntity<Props>, any>): T extends {} ? T & EntityMapperPayload : {
...
export interface IAutoMapper<Props> {
    valueObjectToObj(valueObject: IValueObject<Props>): {
        [key in keyof Props]: any;
    };
    entityToObj(entity: IEntity<Props>): {
        [key in keyof Props]: any;
    } & EntityMapperPayload;
}
